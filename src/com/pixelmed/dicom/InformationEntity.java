...
/**
 * <p>
 * A class to provide enumerated constants for the entities of the DICOM
 * Information Model.
 * </p>
 * 
 * <p>
 * Used to categorize attributes in the
 * {@link com.pixelmed.dicom.DicomDictionary DicomDictionary} and in the
 * {@link com.pixelmed.database com.pixelmed.database} package.
 * </p>
 * 
 * @author dclunie
 */
public class InformationEntity implements Comparable
{
	 ...
	 * 
	 * @param test
	 *            a String name, whose case is ignored
	...
	public static InformationEntity fromString(String test)
	{
		if (test != null)
		{
			...
			if (name.equals("PATIENT"))
				...
				return STUDY;
			else if (name.equals("PROCEDURESTEP"))
				return PROCEDURESTEP;
			else if (name.equals("SERIES"))
				return SERIES;
			else if (name.equals("CONCATENATION"))
				return CONCATENATION;
	...
	/**
	 * <p>
	 * Is this information entity higher in the model than the specified
	 * information entity ?
	 * </p>
	 * 
	 * @param ie
	 *            the information entity with which to compare
	 * @return a -ve value if this information entity higher in the model than
	 *         the specified information entity
	 */
