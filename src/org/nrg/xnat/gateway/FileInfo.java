...
//	public FileMetaInfo metaInfo;
	...
	public FileInfo(Dataset ds, String fname)
	{
		patID = ds.getString(Tags.PatientID);
		patName = ds.getString(Tags.PatientName);
		...
		sopCUID = ds.getString(Tags.SOPClassUID);
		tsUID = ds.getFileMetaInfo().getString(Tags.TransferSyntaxUID);
		fileID = fname;
		size = new File(fname).length();
		fileRetrieveAET=XNATGatewayServer.getInstance().getCalledAET();
...
//		metaInfo=ds;
	...
	public String toString()
	{
		...
		// + ", extRetrieveAET=" + extRetrieveAET
				// + ", fileRetrieveAET=" + fileRetrieveAET +
				// ", basedir=" + basedir
