...
{// !! extends ServiceMBeanSupport {
	...
	private TLSConfigDelegate tlsConfig = new TLSConfigDelegate(mBeanSrv);

	// !! private DicomSecurityDelegate dicomSecurity = new
	// DicomSecurityDelegate(srv);
	...
	{
		/*
		 * long eventID = this.getNextNotificationSequenceNumber(); Notification
		 * notif = new Notification(CallingAetChanged.class.getName(), this,
		 * eventID ); notif.setUserData( new
		 * CallingAetChanged(affectedCalledAETs, newCallingAETs) );
