 ...
 * other Sync objects, <em>outer</em> and <em>inner</em>. The acquire operation
 * invokes <em>outer</em>.acquire() followed by <em>inner</em>.acquire(), but
 * backing out of outer (via release) upon an exception in inner. The other
