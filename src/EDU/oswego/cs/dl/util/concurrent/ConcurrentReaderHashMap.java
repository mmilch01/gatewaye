			...
			Serializable
{
	...
	protected static class Entry implements Map.Entry
	{
		 ...
		 * guarantee lack of concurrent modification), <tt>setValue</tt> is not
		 * strictly guaranteed to actually replace the value field obtained via
		 * the <tt>get</tt> operation of the underlying hash table in
