 ...
 * level</em> of 32. This allows a maximum of 32 put and/or remove operations to
 * proceed concurrently. This level is an upper bound on concurrency, not a
 * guarantee, since it interacts with how well-strewn elements are across bins
 * of the table. (The preset value in part reflects the fact that even on large
			...
			Serializable
{
	 ...
	 *            the key that needs to be removed.
	 * @param value
	 *            the associated value. If the value is null, it means
	 *            "any value".
	 * @return the value to which the key had been mapped in this table, or
	 *         <code>null</code> if the key did not have a mapping.
	 * @exception NullPointerException
	...
	protected static class Entry implements Map.Entry
	{
		 ...
		 * can guarantee lack of concurrent modification, <tt>getValue</tt>
		 * <em>might</em> return null, reflecting the fact that the entry has
		 * been concurrently removed. However, there are no assurances that
